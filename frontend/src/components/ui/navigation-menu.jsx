...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center  bg-background px-4 py-2 text-sm font-normal font-snas transition-colors sm:hover:border-b-2  transition ease-in-out sm:hover:border-primary focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50"
);
...
const NavigationMenuLink = React.forwardRef(
  ({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Link
      ref={ref}
      className={cn("text-sm font-medium text-blue-600", className)}
      {...props}
    />
  )
);
